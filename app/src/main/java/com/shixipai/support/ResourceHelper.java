...
public class ResourceHelper {
    ...
    public static int getColor(int colorId) {
        return ShiXiPaiApp.getContext().getResources().getColor(colorId);
    }

    public static Drawable getDrawable(int drawableId) {
        return ShiXiPaiApp.getContext().getResources().getDrawable(drawableId);
    }

    public static String getString(int stringId) {
        return ShiXiPaiApp.getContext().getResources().getString(stringId);
    }

    public static String[] getStringArrays(int arrayId) {
        return ShiXiPaiApp.getContext().getResources().getStringArray(arrayId);
    }
